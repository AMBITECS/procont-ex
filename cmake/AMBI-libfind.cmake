...
#--------------------------------------------------------------------------------------
function(find_mod PREFIX)
    # - Try to find library with 'PREFIX' named 'NAMES'
    ...
    if(LIB_INAMES)
        ...
        unset(${PREFIX}_INCLUDE_DIR CACHE)  # Nothing to fing - unset this
    endif()

    # Library itself
    if(LIB_NAMES)
        find_library(${PREFIX}_LIBRARY NAMES ${LIB_NAMES} PATHS ${LIB_PATHS} ${${PREFIX}_PKGCONF_LIBRARY_DIRS})
        # Set the libraries for libfind_process
        # NOTE: Singular variables for this library, plural for libraries this this lib depends on.
        set(${PREFIX}_PROCESS_LIBS ${PREFIX}_LIBRARY ${DEPS_LIBRARIES})
    else()
        unset(${PREFIX}_LIBRARY CACHE)      # Nothing to fing - unset this
    endif()
