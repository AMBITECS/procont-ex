...
// Задаём размер каждой из категорий регистров (byte)
constexpr unsigned int REGISTRY_SIZE = 65536;
...
private:
    ...
    struct RegStorage {
        Storage A;  // A - текущий cлой данных
        Storage B;  // B - предыдущий cлой данных
    };
