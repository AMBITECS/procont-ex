...
/*--- OLD&BAD ---*/
//#define __GET_VAR_BY_REF(name, ...)                       ((name.flags & __IEC_FORCE_FLAG) ? &(name.fvalue __VA_ARGS__) : &(name.value __VA_ARGS__))
/*---------------*/
...
/*--- OLD ---*/
//#define __SET_VAR(prefix, name, suffix, new_value)          if (!(prefix name.flags & __IEC_FORCE_FLAG)) prefix name.value suffix = new_value
//#define __SET_VAR(prefix, name, suffix, new_value)          __SET_VAR2(prefix, name, suffix, new_value)
/*-----------*/
